...
export default function ProfilePage() {
  ...
  useEffect(() => {
    setProfile(documentStore.getActiveProfile());
  }, []);

  const handleSave = (e: React.FormEvent) => {
    e.preventDefault();
    documentStore.saveProfile(profile);
    documentStore.setActiveProfileId(profile.id);
  ...
  const handleReset = () => {
    ...
    documentStore.saveProfile(DEFAULT_ACCESSIBILITY_PROFILE);
  };
