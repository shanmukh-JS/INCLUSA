  ...
  return (
    <section className="py-20 bg-white border-t-2 border-[var(--border-strong)]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 p-6 sm:p-8 rounded-3xl bg-[var(--bg-primary)] border-3 border-[var(--border-strong)] shadow-[8px_8px_0_0_#192138] flex flex-col md:flex-row items-center justify-around gap-6 text-center md:text-left">
          {/* Before */}
          <div className="space-y-1">
            <span className="text-xs font-black uppercase tracking-wider text-rose-700 block">
              BEFORE INCLUSA
            </span>
            <div className="text-5xl sm:text-6xl font-mono font-black text-rose-700">
              42 <span className="text-2xl font-sans text-[var(--text-muted)] font-normal">/ 100</span>
            </div>
            <span className="text-xs font-bold text-rose-800 bg-rose-100 px-3 py-1 rounded-full border border-rose-300 inline-block mt-1">
              6 Inaccessible Barriers Detected
            </span>
          </div>

          {/* Center Pipeline Path */}
          <div className="flex flex-col items-center gap-2 py-2">
            <div className="flex items-center gap-1.5 flex-wrap justify-center text-[10px] font-black uppercase text-[var(--text-primary)]">
              <span className="px-2 py-0.5 rounded bg-sky-100 border border-sky-300">Understand</span>
              <span>→</span>
              <span className="px-2 py-0.5 rounded bg-rose-100 border border-rose-300">Audit</span>
              <span>→</span>
              <span className="px-2 py-0.5 rounded bg-amber-200 border-2 border-[var(--border-strong)] text-amber-950 shadow-sm">Personalize</span>
              <span>→</span>
              <span className="px-2 py-0.5 rounded bg-purple-100 border border-purple-300">Transform</span>
              <span>→</span>
              <span className="px-2 py-0.5 rounded bg-emerald-100 border border-emerald-300">Verify</span>
            </div>
            <div className="text-xs font-black text-[#059669] flex items-center gap-1 mt-1">
              <TrendingUp className="h-4 w-4" />
              <span>+52 Points Verified Improvement</span>
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="text-5xl sm:text-6xl font-mono font-black text-emerald-800">
              94 <span className="text-2xl font-sans text-[var(--text-muted)] font-normal">/ 100</span>
            </div>
            <span className="text-xs font-black text-emerald-950 bg-emerald-100 px-3 py-1 rounded-full border border-emerald-300 inline-block mt-1">
              All Detected Barriers Resolved
            </span>
          </div>
        </div>

        {/* Personalized Example Showcase Card */}
        <div className="p-6 sm:p-10 rounded-3xl bg-white border-3 border-[var(--border-strong)] shadow-[8px_8px_0_0_#192138]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                  ...
                  <div className="space-y-3 text-xs leading-relaxed text-[var(--text-primary)]">
                    ...
                    <div className="p-3.5 rounded-xl bg-white border border-purple-300 text-purple-950 shadow-sm">
                      <span className="font-black text-[11px] uppercase tracking-wide block mb-1 text-purple-900">
                        ✓ 3. Telugu Translation (తెలుగు అనువాదం):
                      </span>
                      ఆర్థిక వ్యూహం మరియు వృద్ధి నివేదిక 2025 — మొత్తం వార్షిక ఆదాయం $100 మిలియన్ల నుండి $185 మిలియన్లకు (85% వృద్ధి) పెరిగింది.
                    </div>
                  </div>
                ) : (
                  <div className="space-y-3 text-xs leading-relaxed text-[var(--text-secondary)]">
                    <div className="p-3.5 rounded-xl bg-rose-50 border border-rose-300 text-rose-950">
                      <span className="font-black text-[11px] block mb-1 text-rose-800">
                        ❌ Critical Barrier: Visual Figure 1 (Missing Alt Text & Data Table)
                      </span>
                    ...
                    <div className="p-3.5 rounded-xl bg-rose-50 border border-rose-300 text-rose-950">
                      <span className="font-black text-[11px] block mb-1 text-rose-800">
                        ❌ High Barrier: Dense Jargon (Flesch-Kincaid Grade 15.4)
                      </span>
            ...
            <div className="lg:col-span-5 p-6 rounded-2xl bg-[var(--bg-primary)] border-2 border-[var(--border-strong)] shadow-sm space-y-5">
              <div>
