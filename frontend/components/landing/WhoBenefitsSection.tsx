...
export const WhoBenefitsSection: React.FC = () => {
  const personas = [
    ...
    },
    {
      ...
      howInclusaHelps: 'Provides accurate Telugu (తెలుగు) and Hindi (हिंदी) translations while strictly preserving document structure.',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {personas.map((p, i) => {
            ...
            return (
              <div
                key={i}
                className="p-7 rounded-3xl bg-[var(--bg-primary)] border-2 border-[var(--border-strong)] shadow-[4px_4px_0_0_#192138] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0_0_#192138] transition-all flex flex-col justify-between"
              >
                <div>
