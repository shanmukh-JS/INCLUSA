...
export const Navbar: React.FC = () => {
  ...
  useEffect(() => {
    setActiveProfile(documentStore.getActiveProfile());
  }, [pathname]);
  ...
  return (
    <header className="sticky top-4 z-40 w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="flex h-16 items-center justify-between px-4 sm:px-6 rounded-2xl bg-white/95 backdrop-blur-md border-2 border-[var(--border-strong)] shadow-[0_6px_0_0_#192138] transition-all">
        ...
        <div className="flex items-center gap-2.5">
          {activeProfile && (
            <Link
              href="/profile"
              title="Your Active Accessibility Profile"
              className="hidden lg:flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-300 text-emerald-900 hover:bg-emerald-100 transition-colors"
            >
