...
export const VerificationSection: React.FC = () => {
  ...
  return (
    <ScrollScene id="verification-scene" className="py-20 bg-[var(--bg-secondary)]/40 border-t-2 border-[var(--border-strong)] overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <ScrollLayer depth="midground" speed={-0.04} maxOffset={30}>
          <ScrollReveal direction="up" distance={25} delay={60} duration={800}>
            <div className="p-8 sm:p-12 rounded-3xl bg-white border-3 border-[var(--border-strong)] shadow-[8px_8px_0_0_#192138] mb-10">
              <ScrollStaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-center" staggerMs={80}>
                
                {/* Step 1 */}
                <ScrollStaggerItem index={0}>
                  <div className="p-6 rounded-2xl bg-[var(--bg-primary)] border-2 border-[var(--border-strong)] shadow-[3px_3px_0_0_#192138] space-y-2 h-full">
                ...
                <ScrollStaggerItem index={3}>
                  <div className="p-6 rounded-2xl bg-emerald-50 border-2 border-[var(--border-strong)] shadow-[3px_3px_0_0_#192138] space-y-2 h-full">
        ...
        <ScrollLayer depth="foreground" speed={0.06} maxOffset={30}>
          <ScrollReveal direction="up" distance={25} delay={100} duration={800}>
            <div className="p-6 sm:p-8 rounded-3xl bg-white border-3 border-[var(--border-strong)] shadow-[6px_6px_0_0_#192138]">
              ...
              <ScrollStaggerContainer className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3" staggerMs={55}>
                {weights.map((w, idx) => (
                  <ScrollStaggerItem key={w.name} index={idx}>
                    <div
