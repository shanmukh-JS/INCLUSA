...
import { XCircle, CheckCircle2, ArrowRight, Sparkles, Check, Minus } from 'lucide-react';
...
export const WhyInclusaSection: React.FC = () => {
  ...
  return (
    <ScrollScene id="why-inclusa-scene" className="py-20 bg-[var(--bg-secondary)]/40 border-t-2 border-[var(--border-strong)] overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* 2-Column High-Level Comparison with Multi-Depth Interaction */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-12">
          
          {/* General AI / Traditional Tools Card (5 cols) */}
          <ScrollLayer depth="midground" speed={-0.05} maxOffset={30} className="lg:col-span-5 flex">
            <ScrollReveal direction="up" distance={25} delay={50} duration={750} className="w-full flex">
              <div className="w-full p-8 rounded-3xl bg-white border-2 border-rose-300 shadow-[4px_4px_0_0_#FDA4AF] flex flex-col justify-between h-full">
                <div>
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      <h3 className="text-xl font-black text-[var(--text-primary)]">
                        General AI & Traditional Checkers
                      </h3>
                      <p className="text-xs font-bold text-rose-700">
                        Passive detection without remediation
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 mb-6">
                    <div className="p-3 rounded-xl bg-rose-50 border border-rose-200 text-xs font-bold text-rose-950 flex items-center gap-2">
                      ...
                      <span>1. Scrape raw text without visual layout awareness</span>
                    </div>
                    <div className="p-3 rounded-xl bg-rose-50 border border-rose-200 text-xs font-bold text-rose-950 flex items-center gap-2">
                      <span className="h-2 w-2 rounded-full bg-rose-500" />
                      <span>2. Generate generic bullet points without WCAG context</span>
                    </div>
          ...
          {/* INCLUSA Card (7 cols - Dominant Foreground Depth) */}
          <ScrollLayer depth="foreground" speed={0.07} maxOffset={40} scaleDepth={0.03} className="lg:col-span-7 flex">
            <ScrollReveal direction="up" distance={25} delay={100} duration={800} className="w-full flex">
              <div className="w-full p-8 sm:p-10 rounded-3xl bg-white border-3 border-[var(--border-strong)] shadow-[8px_8px_0_0_#192138] flex flex-col justify-between relative overflow-hidden h-full">
                <div>
                  <div className="flex items-center gap-3 mb-6">
        ...
        <ScrollLayer depth="content">
          <ScrollReveal direction="up" distance={25} delay={140} duration={800}>
